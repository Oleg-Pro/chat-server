...
//go:generate minimock -i github.com/Oleg-Pro/chat-server/internal/repository.ChatRepository -o chat_repository_minimock.go -n ChatRepositoryMock -p mocks
...
type ChatRepositoryMock struct {
	...
	funcCreate          func(ctx context.Context, info *model.ChatInfo) (i1 int64, err error)
	funcCreateOrigin    string
	inspectFuncCreate   func(ctx context.Context, info *model.ChatInfo)
...
func (mmCreate *mChatRepositoryMockCreate) Expect(ctx context.Context, info *model.ChatInfo) *mChatRepositoryMockCreate {
...
func (mmCreate *mChatRepositoryMockCreate) ExpectInfoParam2(info *model.ChatInfo) *mChatRepositoryMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("ChatRepositoryMock.Create mock is already set by Set")
	}
...
func (mmCreate *mChatRepositoryMockCreate) Inspect(f func(ctx context.Context, info *model.ChatInfo)) *mChatRepositoryMockCreate {
...
func (mmCreate *mChatRepositoryMockCreate) Set(f func(ctx context.Context, info *model.ChatInfo) (i1 int64, err error)) *ChatRepositoryMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mChatRepositoryMockCreate) When(ctx context.Context, info *model.ChatInfo) *ChatRepositoryMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("ChatRepositoryMock.Create mock is already set by Set")
	}
...
func (mmCreate *ChatRepositoryMock) Create(ctx context.Context, info *model.ChatInfo) (i1 int64, err error) {
...
func (mmDelete *mChatRepositoryMockDelete) Return(i1 int64, err error) *ChatRepositoryMock {
	if mmDelete.mock.funcDelete != nil {
		mmDelete.mock.t.Fatalf("ChatRepositoryMock.Delete mock is already set by Set")
	}
	...
	mmDelete.defaultExpectation.results = &ChatRepositoryMockDeleteResults{i1, err}
	mmDelete.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
	return mmDelete.mock
}

// Set uses given function f to mock the ChatRepository.Delete method
func (mmDelete *mChatRepositoryMockDelete) Set(f func(ctx context.Context, id int64) (i1 int64, err error)) *ChatRepositoryMock {
	if mmDelete.defaultExpectation != nil {
...
func (e *ChatRepositoryMockDeleteExpectation) Then(i1 int64, err error) *ChatRepositoryMock {
	e.results = &ChatRepositoryMockDeleteResults{i1, err}
	return e.mock
}
...
func (mmDelete *ChatRepositoryMock) Delete(ctx context.Context, id int64) (i1 int64, err error) {
