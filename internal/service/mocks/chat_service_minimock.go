...
//go:generate minimock -i github.com/Oleg-Pro/chat-server/internal/service.ChatService -o chat_service_minimock.go -n ChatServiceMock -p mocks
...
func (mmCreate *mChatServiceMockCreate) Expect(ctx context.Context, info *model.ChatInfo) *mChatServiceMockCreate {
...
func (mmCreate *mChatServiceMockCreate) ExpectInfoParam2(info *model.ChatInfo) *mChatServiceMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("ChatServiceMock.Create mock is already set by Set")
	}
...
func (mmCreate *mChatServiceMockCreate) Inspect(f func(ctx context.Context, info *model.ChatInfo)) *mChatServiceMockCreate {
...
func (mmCreate *mChatServiceMockCreate) Set(f func(ctx context.Context, info *model.ChatInfo) (i1 int64, err error)) *ChatServiceMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mChatServiceMockCreate) When(ctx context.Context, info *model.ChatInfo) *ChatServiceMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("ChatServiceMock.Create mock is already set by Set")
	}
...
func (mmCreate *ChatServiceMock) Create(ctx context.Context, info *model.ChatInfo) (i1 int64, err error) {
...
func (mmDelete *mChatServiceMockDelete) Return(i1 int64, err error) *ChatServiceMock {
	if mmDelete.mock.funcDelete != nil {
		mmDelete.mock.t.Fatalf("ChatServiceMock.Delete mock is already set by Set")
	}
	...
	mmDelete.defaultExpectation.results = &ChatServiceMockDeleteResults{i1, err}
	mmDelete.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
	return mmDelete.mock
}

// Set uses given function f to mock the ChatService.Delete method
func (mmDelete *mChatServiceMockDelete) Set(f func(ctx context.Context, id int64) (i1 int64, err error)) *ChatServiceMock {
	if mmDelete.defaultExpectation != nil {
...
func (e *ChatServiceMockDeleteExpectation) Then(i1 int64, err error) *ChatServiceMock {
	e.results = &ChatServiceMockDeleteResults{i1, err}
	return e.mock
}
...
func (mmDelete *ChatServiceMock) Delete(ctx context.Context, id int64) (i1 int64, err error) {
